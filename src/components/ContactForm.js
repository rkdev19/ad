    ...
    >
      <div className="container">
        ...
        <div className="row row-custom">
          <div className="col-sm-12 col-sm-12 col-md-3 col-lg-3 align-right">
            {/* Section numbers */}
            <div className="numbers-items contacts-items">
              ...
              >
                ...
                <div className="num">+91 9730732440</div>
              </div>
              <div
                className="numbers-item"
              >
                ...
                <div className="num">amoldhole2050@gmail.com</div>
              </div>
              <div
                className="numbers-item"
              >
                ...
                <div className="num">Pune, Maharashtra</div>
              </div>
            </div>
          </div>
